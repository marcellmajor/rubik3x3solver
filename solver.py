...
def main():
    ...
    my_cube = Cube(
        "GOYOOOOOO",
        ["BYOYYYRYY","YGGGGGGGG","WWWWWWWWW","BBOBBBBBY"],
        "RRRRRRRRB"
    )
    my_cube.test_cube()
    ...
    #             _act_chromosome = selected_chromosome + _act_combo
    ...
    while (not ((_fitness > (solved_fitness - chromosome_size)) and (_best_index < 25)) ) and _counter < 500000000:
        _temp_cube = my_cube.clone()
